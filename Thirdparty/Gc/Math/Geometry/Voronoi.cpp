...
/** @cond */
template GC_DLL_EXPORT void HypersphereVoronoiDiagram(const System::Collection::Array<1, Vector<3, Float32>> & points,
                                                      System::Collection::Array<1, Float32> & vd);
template GC_DLL_EXPORT void HypersphereVoronoiDiagram(const System::Collection::Array<1, Vector<3, Float64>> & points,
                                                      System::Collection::Array<1, Float64> & vd);
template GC_DLL_EXPORT void HypersphereVoronoiDiagram(const System::Collection::Array<1, Vector<2, Float32>> & points,
                                                      System::Collection::Array<1, Float32> & vd);
template GC_DLL_EXPORT void HypersphereVoronoiDiagram(const System::Collection::Array<1, Vector<2, Float64>> & points,
                                                      System::Collection::Array<1, Float64> & vd);
/** @endcond */
}
}
