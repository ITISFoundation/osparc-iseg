...
public:
  ...
  void
  SetLookupTable(const LookupTable & lut);

  /**  Compute thinning Image. */
  static void
  ComputeThinImage(OutputImageType * output, const LookupTable & lookupTable);
...
private:
  OpenThinning(const Self &) = delete;
  void
