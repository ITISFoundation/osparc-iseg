...
protected:
  ...
  ~vtkGDCMMedicalImageProperties() override;
...
private:
  ...
  vtkGDCMMedicalImageProperties(const vtkGDCMMedicalImageProperties&) = delete;
  void operator=(const vtkGDCMMedicalImageProperties&) = delete;
};
