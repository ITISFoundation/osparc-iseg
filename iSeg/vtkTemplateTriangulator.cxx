		0, 4, 0, 3, 2, 5, 1, 5, 4, 2, 3, 1, 0, 0, 1, 2, 3, 4, 5, 5, 4, 2, 3, 1, 0,
		4, 2, 5, 0, 3, 1, 2, 5, 4, 1, 0, 3, 2, 5, 4, 1, 0, 3, 4, 3, 0, 5, 2, 1, 4,
		3, 0, 5, 2, 1, 3, 5, 1, 4, 0, 2, 3, 0, 4, 1, 5, 2, 5, 4, 2, 3, 1, 0, 4, 3,
		0, 5, 2, 1, 5, 4, 2, 3, 1, 0, 0, 1, 2, 3, 4, 5 };

	short triTrafo[64][4] = { 0, 1, 2, 3, 0, 1, 2, 3, 2, 0, 1, 3, 0, 1, 2, 3,
		3, 0, 2, 1, 0, 3, 1, 2, 0, 2, 3, 1, 0, 1, 2, 3, 1, 2, 0, 3, 
		1, 2, 0, 3, 2, 0, 1, 3, 0, 1, 2, 3, 1, 2, 0, 3, 0, 1, 3, 2,
		2, 0, 1, 3, 0, 1, 2, 3, 1, 3, 2, 0, 1, 0, 3, 2, 2, 0, 1, 3,
		0, 1, 2, 3, 3, 1, 0, 2, 0, 3, 1, 2, 3, 0, 1, 2, 0, 3, 1, 2,
		1, 3, 2, 0, 1, 2, 0, 3, 1, 2, 3, 0, 1, 2, 0, 3, 1, 3, 2, 0,
		1, 0, 3, 2, 2, 0, 1, 3, 0, 1, 2, 3, 3, 2, 1, 0, 0, 1, 2, 3,
		2, 3, 0, 1, 2, 0, 3, 1, 3, 0, 2, 1, 3, 0, 2, 1, 0, 2, 3, 1,
		0, 2, 3, 1, 2, 1, 3, 0, 1, 2, 0, 3, 2, 0, 1, 3, 2, 0, 1, 3,
		3, 2, 0, 1, 1, 2, 0, 3, 2, 3, 0, 1, 2, 0, 1, 3, 3, 2, 1, 0,
		1, 3, 0, 2, 3, 2, 1, 0, 0, 1, 2, 3, 3, 2, 1, 0, 3, 1, 0, 2,
		3, 0, 2, 1, 3, 0, 2, 1, 1, 3, 2, 0, 1, 3, 2, 0, 2, 1, 3, 0,
		1, 2, 0, 3, 3, 2, 1, 0, 1, 3, 2, 0, 3, 2, 1, 0, 0, 1, 2, 3
	};

	// needed for DetermineTetraSubdivisionCase
	short casenr[64] = { 10, 0, 0, 1, 0, 1, 1, 3, 0, 1, 1, 4, 2, -5, 5, 7, 0, 1, 2,
		5, 1, 4, -5, 7, 1, 3, -5, 7, 5, 7, 6, 8, 0, 2, 1, -5, 1, 5, 4, 7, 1, 5, 3,
		7, -5, 6, 7, 8, 1, -5, 5, 6, 3, 7, 7, 8, 4, 7, 7, 8, 7, 8, 8, 9, };
...
//////////////////////////////////////////////////////////////////////////
vtkTemplateTriangulator::vtkTemplateTriangulator()
{
	Pimple = new vtkPimple;
}
...
int vtkTemplateTriangulator::AddPyramid(vtkIdType v1,vtkIdType v2,vtkIdType v3,
	vtkIdType v4,vtkIdType v5, int dom)
{
	int numTets = 2;
...
int vtkTemplateTriangulator::AddPrism(vtkIdType v1,vtkIdType v2,vtkIdType v3,
	vtkIdType v4,vtkIdType v5,vtkIdType v6,int dom)
{
	int numTets = 0;

	bool lookUpTable[] = {
		(std::max(v2, v4) < std::max(v1, v5)),
...
int vtkTemplateTriangulator::AddHexahedron(vtkIdType v0,vtkIdType v1,vtkIdType v2,
	vtkIdType v3,vtkIdType v4,vtkIdType v5,vtkIdType v6,vtkIdType v7, int dom)
{
	...
	for (int k=0; k<6; k++)
	{
		...
		lookupTable[k] = (std::max(vi[face[0]], vi[face[2]]) < std::max(vi[face[1]], vi[face[3]]));
...
short vtkTemplateTriangulator::DetermineTetraSubdivisionCase( short code[6], 
	short edgeMap[6] /*= NULL*/, short vertexMap[4] /*= NULL*/, 
...
void vtkTemplateTriangulator::AddMultipleDomainTetrahedron(const  vtkIdType vi[4], const int domain[4] )
{
	...
	short vertexMap[4];
	short faceMap[4];
	const short casenr = DetermineTetraSubdivisionCase(code, edgeMap, vertexMap, faceMap);
	...
	if (casenr == 8 || casenr == 9)
	{
		for (short j=0; j<4; j++)
		{
				...
				domain[tet_triangles[j][1]] != domain[tet_triangles[j][2]])
			{
				...
				vtkPimple::TriangleNodeMap::iterator tri_it = Pimple->TriangleTable.find(tri);
	...
	case 3:
		{
			...
			AddPrism(edgeNodes[edgeMap[0]], edgeNodes[edgeMap[1]], edgeNodes[edgeMap[2]], 
				vi[vertexMap[1]], vi[vertexMap[2]], vi[vertexMap[3]],
				domain[vertexMap[1]]);
		}
		break;
	case 6:
	...
	case 8:
		{
			...
			AddHexahedron(vi[vertexMap[2]], edgeNodes[edgeMap[1]], faceNodes[faceMap[3]], edgeNodes[edgeMap[3]], 
				vi[vertexMap[3]], edgeNodes[edgeMap[2]], faceNodes[faceMap[2]], edgeNodes[edgeMap[4]], 
				domain[vertexMap[2]]);

			AddPrism(vi[vertexMap[1]], edgeNodes[edgeMap[4]], edgeNodes[edgeMap[3]],
				edgeNodes[edgeMap[0]], faceNodes[faceMap[2]], faceNodes[faceMap[3]], domain[vertexMap[1]]);

			AddPrism(vi[vertexMap[0]], edgeNodes[edgeMap[1]], edgeNodes[edgeMap[2]],
				edgeNodes[edgeMap[0]], faceNodes[faceMap[3]], faceNodes[faceMap[2]], domain[vertexMap[0]]);
		}
		break;
	case 9:
		{
			...
			GetPoint(vi[2], x3);
			GetPoint(vi[3], x4);
			vtkIdType c0 = AddPoint(
				0.25*(x1[0]+x2[0]+x3[0]+x4[0]),
				0.25*(x1[1]+x2[1]+x3[1]+x4[1]),
				0.25*(x1[2]+x2[2]+x3[2]+x4[2]) );

			// v0,e0,f3,e1, e2,f2,c0,f1
			AddHexahedron(vi[vertexMap[0]], edgeNodes[edgeMap[0]], faceNodes[faceMap[3]], edgeNodes[edgeMap[1]], 
				edgeNodes[edgeMap[2]], faceNodes[faceMap[2]], c0, faceNodes[faceMap[1]], 
				domain[vertexMap[0]]);

			// v1,e3,f3,e0, e4,f0,c0,f2
			AddHexahedron(vi[vertexMap[1]], edgeNodes[edgeMap[3]], faceNodes[faceMap[3]], edgeNodes[edgeMap[0]], 
				edgeNodes[edgeMap[4]], faceNodes[faceMap[0]], c0, faceNodes[faceMap[2]], 
				domain[vertexMap[1]]);

			// v2,e1,f3,e3, e5,f1,c0,f0
			AddHexahedron(vi[vertexMap[2]], edgeNodes[edgeMap[1]], faceNodes[faceMap[3]], edgeNodes[edgeMap[3]], 
				edgeNodes[edgeMap[5]], faceNodes[faceMap[1]], c0, faceNodes[faceMap[0]], 
				domain[vertexMap[2]]);

			// v3,e2,f1,e5, e4,f2,c0,f0
			AddHexahedron(vi[vertexMap[3]], edgeNodes[edgeMap[2]], faceNodes[faceMap[1]], edgeNodes[edgeMap[5]], 
				edgeNodes[edgeMap[4]], faceNodes[faceMap[2]], c0, faceNodes[faceMap[0]], 
				domain[vertexMap[3]]);
		}
		break;
	case 10:
