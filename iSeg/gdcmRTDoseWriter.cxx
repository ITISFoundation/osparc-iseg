...
RTDoseWriter::RTDoseWriter()
{
  ...
  ImageOrientationPatient[0] = ImageOrientationPatient[1] = ImageOrientationPatient[2] = 0.0;
  ImageOrientationPatient[3] = ImageOrientationPatient[4] = ImageOrientationPatient[5] = 0.0;
  ImagePositionPatient[0] = ImagePositionPatient[1] = ImagePositionPatient[2] = 0.0;
  SliceThickness = 0.0;
  Rows = 0;
  Columns = 0;
  BitsAllocated = 0;
  ...
  InstanceCreationDate[0] = InstanceCreationDate[1] = InstanceCreationDate[2] = 0;
  InstanceCreationDateExists = false;
  InstanceCreationTime[0] = InstanceCreationTime[1] = InstanceCreationTime[2] = 0;
...
{
  _attributeTagVRType["PatientName"]					      = TagVRTypePair(Tag(0x0010,0x0010), VR::PN);
  _attributeTagVRType["PatientID"]					        = TagVRTypePair(Tag(0x0010,0x0020), VR::LO);
  _attributeTagVRType["PatientBirthDate"]				    = TagVRTypePair(Tag(0x0010,0x0030), VR::DA);
  _attributeTagVRType["PatientSex"]					        = TagVRTypePair(Tag(0x0010,0x0040), VR::CS);
  _attributeTagVRType["StudyInstanceUID"]				    = TagVRTypePair(Tag(0x0020,0x000D), VR::UI);
  ...
  _attributeTagVRType["ReferringPhysicianName"]		  = TagVRTypePair(Tag(0x0008,0x0090), VR::PN);
  _attributeTagVRType["StudyID"]						        = TagVRTypePair(Tag(0x0020,0x0010), VR::SH);
  _attributeTagVRType["AccessionNumber"]				    = TagVRTypePair(Tag(0x0008,0x0050), VR::SH);
  _attributeTagVRType["StudyDescription"]				    = TagVRTypePair(Tag(0x0008,0x1030), VR::LO);
  _attributeTagVRType["ReferencedStudySequence"]		= TagVRTypePair(Tag(0x0008,0x1110), VR::SQ);
  _attributeTagVRType["Modality"]						        = TagVRTypePair(Tag(0x0008,0x0060), VR::CS);
  _attributeTagVRType["SeriesInstanceUID"]			    = TagVRTypePair(Tag(0x0020,0x000E), VR::UI);
  _attributeTagVRType["SeriesNumber"]					      = TagVRTypePair(Tag(0x0020,0x0011), VR::IS);
  _attributeTagVRType["OperatorsName"]				      = TagVRTypePair(Tag(0x0008,0x1070), VR::PN);
  _attributeTagVRType["FrameOfReferenceUID"]			  = TagVRTypePair(Tag(0x0020,0x0052), VR::UI);
  _attributeTagVRType["PositionReferenceIndicator"]	= TagVRTypePair(Tag(0x0020,0x1040), VR::LO);
  _attributeTagVRType["Manufacturer"]					      = TagVRTypePair(Tag(0x0008,0x0070), VR::LO);
  _attributeTagVRType["StationName"]					      = TagVRTypePair(Tag(0x0008,0x1010), VR::SH);
  _attributeTagVRType["ManufacturersModelName"]	    = TagVRTypePair(Tag(0x0008,0x1090), VR::LO);
  _attributeTagVRType["SoftwareVersions"]     	    = TagVRTypePair(Tag(0x0008,0x1020), VR::LO);
  _attributeTagVRType["InstanceNumber"]				      = TagVRTypePair(Tag(0x0020,0x0013), VR::IS);
  _attributeTagVRType["ContentDate"]				        = TagVRTypePair(Tag(0x0008,0x0023), VR::DA);
  _attributeTagVRType["ContentTime"]  				      = TagVRTypePair(Tag(0x0008,0x0033), VR::TM);
  _attributeTagVRType["PixelSpacing"]					      = TagVRTypePair(Tag(0x0028,0x0030), VR::DS);
  _attributeTagVRType["ImageOrientationPatient"]		= TagVRTypePair(Tag(0x0020,0x0037), VR::DS);
  _attributeTagVRType["ImagePositionPatient"]			  = TagVRTypePair(Tag(0x0020,0x0032), VR::DS);
  _attributeTagVRType["SliceThickness"]				      = TagVRTypePair(Tag(0x0018,0x0050), VR::DS);
  _attributeTagVRType["SamplesPerPixel"]				    = TagVRTypePair(Tag(0x0028,0x0002), VR::US);
  _attributeTagVRType["PhotometricInterpretation"]	= TagVRTypePair(Tag(0x0028,0x0004), VR::CS);
  ...
  _attributeTagVRType["BitsAllocated"]				      = TagVRTypePair(Tag(0x0028,0x00100), VR::US);
  _attributeTagVRType["BitsStored"]					        = TagVRTypePair(Tag(0x0028,0x0101), VR::US);
  _attributeTagVRType["HighBit"]						        = TagVRTypePair(Tag(0x0028,0x0102), VR::US);
  _attributeTagVRType["PixelRepresentation"]			  = TagVRTypePair(Tag(0x0028,0x0103), VR::US);
  _attributeTagVRType["PixelData"]					        = TagVRTypePair(Tag(0x7fe0,0x0010), VR::OW); // TODO: OW or OB
  _attributeTagVRType["NumberOfFrames"]				      = TagVRTypePair(Tag(0x0028,0x0008), VR::IS);
  _attributeTagVRType["FrameIncrementPointer"]		  = TagVRTypePair(Tag(0x0028,0x0009), VR::AT);
  ...
  _attributeTagVRType["NormalizationPoint"]	        = TagVRTypePair(Tag(0x3004,0x0008), VR::DS);
  _attributeTagVRType["DoseSummationType"]			    = TagVRTypePair(Tag(0x3004,0x000A), VR::CS);
  _attributeTagVRType["ReferencedRTPlanSequence"]		= TagVRTypePair(Tag(0x300C,0x0002), VR::SQ);
  _attributeTagVRType["ReferencedSOPClassUID"]		  = TagVRTypePair(Tag(0x0008,0x1150), VR::UI);
  _attributeTagVRType["ReferencedSOPInstanceUID"]		= TagVRTypePair(Tag(0x0008,0x1155), VR::UI);
  _attributeTagVRType["GridFrameOffsetVector"]		  = TagVRTypePair(Tag(0x3004,0x000C), VR::DS);
  _attributeTagVRType["DoseGridScaling"]				    = TagVRTypePair(Tag(0x3004,0x000E), VR::DS);
  _attributeTagVRType["SOPClassUID"]					      = TagVRTypePair(Tag(0x0008,0x0016), VR::UI);
  _attributeTagVRType["SOPInstanceUID"]				      = TagVRTypePair(Tag(0x0008,0x0018), VR::UI);
  _attributeTagVRType["SpecificCharacterSet"]			  = TagVRTypePair(Tag(0x0008,0x0005), VR::CS);
  _attributeTagVRType["InstanceCreationDate"]			  = TagVRTypePair(Tag(0x0008,0x0012), VR::DA);
  _attributeTagVRType["InstanceCreationTime"]			  = TagVRTypePair(Tag(0x0008,0x0013), VR::TM);
}
...
bool RTDoseWriter::Write()
{
  ...
  if ( GetReferencedRTPlanInstanceUIDCount() <= 0 ) return false; // TODO: Check for different dose summation types
  ...
  double spacing[3] = { GetPixelSpacing()[0], GetPixelSpacing()[1], GetSliceThickness() };
...
inline void RTDoseWriter::WriteGeneralStudyModule(DataSet &ds)
{
  ...
  ReplaceDataElement( ds, std::string("StudyInstanceUID"), GetStudyInstanceUID() );
  ...
  ReplaceDataElement( ds, std::string("ReferringPhysicianName"), GetReferringPhysicianName() );
  ...
  if ( StudyDescriptionExists ) {
    ReplaceDataElement( ds, std::string("StudyDescription"), GetStudyDescription() );
  }
  ...
  if ( GetReferencedStudyInstanceUIDCount() > 0 ) {
    ...
    for ( unsigned int i = 0; i < GetReferencedStudyInstanceUIDCount(); ++i ) {
      ...
      InsertDataElement( nds, std::string("ReferencedSOPClassUID"), GetReferencedStudyClassUID() );
      InsertDataElement( nds, std::string("ReferencedSOPInstanceUID"), GetReferencedStudyInstanceUID(i) );
      sq->AddItem(it);
    }
...
inline void RTDoseWriter::WriteRTSeriesModule(DataSet &ds)
{
  ...
  ReplaceDataElement( ds, std::string("SeriesInstanceUID"), GetSeriesInstanceUID() );
...
inline void RTDoseWriter::WriteFrameOfReferenceModule(DataSet &ds)
{
  ...
  ReplaceDataElement( ds, std::string("FrameOfReferenceUID"), GetFrameOfReferenceUID() );

  // Position Reference Indicator (Type = 2, VM = 1)
  ReplaceDataElement( ds, std::string("PositionReferenceIndicator"), GetPositionReferenceIndicator() );
}
...
inline void RTDoseWriter::WriteGeneralEquipmentModule(DataSet &ds)
{
  ...
  if ( ManufacturersModelNameExists ) {
    ReplaceDataElement( ds, std::string("ManufacturersModelName"), GetManufacturersModelName() );
  }
  ...
  for ( unsigned int i = 0; i < GetSoftwareVersionsCount(); ++i ) {
    InsertDataElement( ds, std::string("SoftwareVersions"), GetSoftwareVersions(i) );
  }
...
inline void RTDoseWriter::WriteGeneralImageModule(DataSet &ds)
{
  ...
  if ( ContentDateExists ) {
    ...
    FormatDate( contentDatePtr[0], contentDatePtr[1], contentDatePtr[2], contentDate );
  ...
  if ( ContentTimeExists ) {
    ...
    FormatTime( contentTimePtr[0], contentTimePtr[1], contentTimePtr[2], contentTime );
...
inline void RTDoseWriter::WriteImagePlaneModule(DataSet &ds)
{
  ...
  for ( unsigned short i = 0; i < 6; ++i ) {
    ...
    InsertDataElement( ds, std::string("ImageOrientationPatient"), imgOrientation );
  }
...
inline void RTDoseWriter::WriteImagePixelModule(DataSet &ds, Image & pixeldata)
{
  ...
  ReplaceDataElement( ds, std::string("PhotometricInterpretation"), GetPhotometricInterpretation() );
...
inline void RTDoseWriter::WriteMultiFrameModule(DataSet &ds)
{
  ...
  ReplaceDataElement( ds, std::string("FrameIncrementPointer"), GetFrameIncrementPointer() );
}
...
inline void RTDoseWriter::WriteRTDoseModule(DataSet &ds)
{
  ...
  case Plan:
    ...
    break;
  case MultiPlan:
    summationType = "MULTI_PLAN";
    break;
  case Fraction:
    summationType = "FRACTION";
    break;
  case Beam:
    summationType = "BEAM";
    break;
  case Brachy:
    summationType = "BRACHY";
    break;
  case ControlPoint:
    summationType = "CONTROL_POINT";
    break;
  }
  ...
  for ( unsigned int i = 0; i < GetReferencedRTPlanInstanceUIDCount(); ++i ) {
    ...
    it.SetVLToUndefined();
    DataSet &nds = it.GetNestedDataSet();		
    InsertDataElement( nds, std::string("ReferencedSOPClassUID"), GetReferencedRTPlanClassUID() );
    InsertDataElement( nds, std::string("ReferencedSOPInstanceUID"), GetReferencedRTPlanInstanceUID(i) );
    sq->AddItem(it);
  }
...
inline void RTDoseWriter::WriteSOPCommonModule(DataSet &ds)
{
  ...
  if ( InstanceCreationDateExists ) {
    ...
    FormatDate( instanceDatePtr[0], instanceDatePtr[1], instanceDatePtr[2], instanceDate );
  ...
  if ( InstanceCreationTimeExists ) {
    ...
    FormatTime( instanceTimePtr[0], instanceTimePtr[1], instanceTimePtr[2], instanceTime );
...
double RTDoseWriter::GetDoseGridScaling()
{
  if (DoseGridScaling == 0.0) {
    ...
    unsigned short decimals = _vrTypeMaxLength[_attributeTagVRType["DoseGridScaling"].second] - 1;
...
void RTDoseWriter::InsertDataElement(DataSet &dataset, const std::string keyword, std::string value, unsigned int vm)
{
...
void RTDoseWriter::ReplaceDataElement(DataSet &dataset, const std::string keyword, std::string value, unsigned int vm)
{
  Tag tag = _attributeTagVRType[keyword].first;
  VR::VRType vr = _attributeTagVRType[keyword].second;
...
void RTDoseWriter::InsertSequence(DataSet &dataset, const std::string keyword, SequenceOfItems *sequence)
{
  Tag tag = _attributeTagVRType[keyword].first;
  VR::VRType vr = _attributeTagVRType[keyword].second;
...
void RTDoseWriter::AdjustVRTypeString(VR::VRType &vr, unsigned int vm, std::string &value)
{
