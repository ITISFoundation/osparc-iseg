...
public:
	...
	void SetFileTypeToASCII() {this->FileType=VTK_ASCII;};
	...
	*/
	...
	vtkSetMacro(FlipTriangles,bool)
	vtkBooleanMacro(FlipTriangles,bool)
...
protected:
	...
	//BTX
	void decomposeFileName(std::string& bname,
						   std::string& extname,
