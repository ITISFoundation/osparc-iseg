...
class ScaleWork : public QDialog
{
	Q_OBJECT
public:
	ScaleWork(SlicesHandler *hand3D, QDir picpath, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~ScaleWork();
...
class ImageMath : public QDialog
{
	Q_OBJECT
public:
	ImageMath(SlicesHandler *hand3D, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~ImageMath();
...
class ImageOverlay : public QDialog
{
	Q_OBJECT
public:
	ImageOverlay(SlicesHandler *hand3D, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~ImageOverlay();
...
class HistoWin : public QWidget
{
	Q_OBJECT
public:
	HistoWin(unsigned int *histo1, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	void update();
...
class ShowHisto : public QDialog
{
	Q_OBJECT
public:
	ShowHisto(SlicesHandler *hand3D, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~ShowHisto();
...
class colorshower : public QWidget
{
	Q_OBJECT
public:
	colorshower(int lx1, int ly1, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
...
class TissueTreeWidget : public QTreeWidget
{
	Q_OBJECT
public:
	TissueTreeWidget(TissueHiearchy *hierarchy, QDir picpath, QWidget *parent = 0);
	~TissueTreeWidget();
...
public:
	...
	void get_current_child_tissues(std::map<tissues_size_t, unsigned short> &types);
	...
	void get_sublevel_child_tissues(std::map<tissues_size_t, unsigned short> &types);
...
private:
	...
	QTreeWidgetItem *find_tissue_item(tissues_size_t type, QTreeWidgetItem *parent = 0);
	void take_children_recursively(QTreeWidgetItem *parent, QList<QTreeWidgetItem *> &appendTo);
	void get_child_tissues_recursively(QTreeWidgetItem *parent, std::map<tissues_size_t, unsigned short> &types);
	unsigned short get_tissue_instance_count_recursively(QTreeWidgetItem *parent, tissues_size_t type);
...
class TissueAdder : public QDialog
{
	Q_OBJECT
public:
	TissueAdder(bool modifyTissue, TissueTreeWidget *tissueTree, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~TissueAdder();
...
class TissueFolderAdder : public QDialog
{
	Q_OBJECT
public:
	TissueFolderAdder(TissueTreeWidget *tissueTree, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~TissueFolderAdder();
...
class TissueHierarchyWidget : public QWidget
{
	Q_OBJECT
public:
	TissueHierarchyWidget(TissueTreeWidget *tissueTree, QWidget *parent = 0, Qt::WindowFlags wFlags = 0);
...
class bits_stack : public QWidget
{
	Q_OBJECT
public:
	bits_stack(SlicesHandler *hand3D, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~bits_stack();
...
signals:
	...
	void begin_datachange(common::DataSelection &dataSelection, QWidget *sender = NULL, bool beginUndo = true);
	void end_datachange(QWidget *sender = NULL, common::EndUndoAction undoAction = common::EndUndo);
	void begin_dataexport(common::DataSelection &dataSelection, QWidget *sender = NULL);
...
class bits_stack_pushdialog : public QDialog
{
	Q_OBJECT
public:
	bits_stack_pushdialog(QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
...
class extoverlay_widget : public QWidget
{
	Q_OBJECT
public:
	extoverlay_widget(SlicesHandler *hand3D, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~extoverlay_widget();
	void newloaded();
...
public:
	...
	MultiDataset_widget(SlicesHandler *hand3D, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~MultiDataset_widget();
	void NewLoaded();
	...
	void SetWorkingData(const int multiDS_index, std::vector<float *> work_bits_vc);
...
protected:
	...
	bool CheckInfoAndAddToList(MultiDataset_widget::SDatasetInfo &newRadioButton, QStringList loadfilenames, unsigned short width, unsigned short height, unsigned short nrofslices);
	bool AddDatasetToList(MultiDataset_widget::SDatasetInfo &newRadioButton, QStringList loadfilenames);
	void CopyImagesSlices(SlicesHandler *handler3D, MultiDataset_widget::SDatasetInfo &newRadioButton, const bool saveOnlyWorkingBits = false);
...
class zoomer_widget : public QWidget
{
	Q_OBJECT
public:
	zoomer_widget(double zoom1, QDir picpath, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~zoomer_widget();
	double get_zoom();
...
/*class QHBoxLayout_fixedheight : public QHBoxLayout
{
public:
	QHBoxLayout_fixedheight(QWidget *parent,int margin=0,int spacing=-1,const char *name=0);
...
class CleanerParams : public QDialog
{
	Q_OBJECT
public:
	CleanerParams(int *rate1, int *minsize1, QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~CleanerParams();
...
class MergeProjectsDialog : public QDialog
{
	Q_OBJECT
public:
	MergeProjectsDialog(QWidget *parent = 0, const char *name = 0, Qt::WindowFlags wFlags = 0);
	~MergeProjectsDialog();
...
class CheckBoneConnectivityDialog : public QWidget
{
	...
	{
		BoneConnectionInfo(const tissues_size_t tis1, const tissues_size_t tis2, const int slice) : TissueID1(tis1), TissueID2(tis2), SliceNumber(slice) {}
		...
		{
			return (SliceNumber == a.SliceNumber && ((TissueID1 == a.TissueID1 && TissueID2 == a.TissueID2) || (TissueID1 == a.TissueID2 && TissueID2 == a.TissueID1)));
		}
	};

public:
	CheckBoneConnectivityDialog(SlicesHandler *hand3D, const char *name, QWidget *parent = 0, Qt::WindowFlags wFlags = 0);
