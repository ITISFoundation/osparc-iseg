...
class MainWindow : public QMainWindow
{
   Q_OBJECT
public:
   MainWindow(SlicesHandler *hand3D, QString locationstring, QDir picpath, QDir tmppath, bool editingmode=false, QWidget *parent=0, const char *name=0, Qt::WindowFlags wFlags=0,char **argv=NULL);
	~MainWindow();
...
private slots:
   ...
   void handle_begin_datachange(common::DataSelection &dataSelection, QWidget *sender = NULL, bool beginUndo = true);
   void handle_end_datachange(QWidget *sender = NULL, common::EndUndoAction undoAction = common::EndUndo);
   void handle_end_datachange(QRect rect, QWidget *sender = NULL, common::EndUndoAction undoAction = common::EndUndo);
   void handle_begin_dataexport(common::DataSelection &dataSelection, QWidget *sender = NULL);
