...
FIND_PACKAGE(Boost 1.64 COMPONENTS filesystem thread unit_test_framework date_time random chrono timer program_options ${BOOST_REQUIRED_LIBS})
if(NOT Boost_FOUND)
	message(WARNING "Boost 1.65 library not found. Reverting to 1.54 as minimum requirement!")
	FIND_PACKAGE(Boost 1.54 REQUIRED COMPONENTS filesystem thread unit_test_framework date_time random chrono timer program_options ${BOOST_REQUIRED_LIBS})
