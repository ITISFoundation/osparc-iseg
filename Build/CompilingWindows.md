...
- [HDF5 installer](https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-1.10): v1.10, or newer

  1. Download the installer _hdf5-1.10.0-win64-vs2013-shared.zip_
  2. Unzip the installer
  3. Run the installer and follow the default instructions

- [ITK source code](https://github.com/InsightSoftwareConsortium/ITK/releases/download/v5.0.1/InsightToolkit-5.0.1.zip): v5.0, or newer
...
- [VTK source code](https://www.vtk.org/files/release/8.2/VTK-8.2.0.tar.gz): v7.1.0, or newer
  ...
  3. Set _ISEG_VTK_OPENGL2_ to ON
  4. Press _Generate_
...
### Compiling iSEG
  ...
  4. Define _HDF5_ROOT_ as the folder where HDF5 was installed (e.g. _C:\Program Files\HDF_Group\HDF5\1.10.0_), press _Configure_
