...
CConfidence::CConfidence(iseg::CSliceHandlerInterface *hand3D, QWidget *parent, const char *name, Qt::WindowFlags wFlags)
 : QWidget1( parent, name, wFlags ),handler3D(hand3D)
{
	...
	bias_header=new QLabel("ConfidenceConnected Algorithm:(Pick with OLC Foreground 1 pixel to start) ",vbox1);
...
void CConfidence::do_work()
{
	...
	typedef itk::CurvatureFlowImageFilter< TInput, TInput > CurvatureFlowImageFilterType;
	CurvatureFlowImageFilterType::Pointer smoothing; 
	smoothing=	CurvatureFlowImageFilterType::New();
	typedef itk::ConfidenceConnectedImageFilter<TInput, TOutput> ConnectedFilterType;
...
QSize CConfidence::sizeHint() const
{
