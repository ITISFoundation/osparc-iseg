...
namespace itk 
{
	...
	public:
		...
		void SetFB(bool b) {
			m_UseForegroundBackground = b;
		}

		void SetGM(bool b) {
			m_UseGradientMagnitude = b;
		}

		void SetIntensity(bool b) {
			m_UseIntensity = b;
		}

		void SetConnectivity(bool b) {
			m_6Connected = b;
		}

		void SetForeground(int b) {
			m_ForegroundValue = b;
		}
		...
		void SetMaxFlowAlgorithm(eMaxFlowAlgorithm alg) {
			m_MaxFlowAlgorithm = alg;
		}
