...
namespace common
{
	...
	void QuaternionToDirectionCosines(const float* quaternion, float* directionCosines);
	void DirectionCosinesToQuaternion(const float* directionCosines, float* quaternion);
