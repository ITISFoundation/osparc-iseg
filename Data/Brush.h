...
void brush(T* slice_data, unsigned slice_width, unsigned slice_height, float dx, float dy, Point p, float const radius, bool draw_or_modify, T f, T f1, F is_locked)
{
...
template<typename T, typename F>
void brush(T* slice_data, unsigned slice_width, unsigned slice_height, Point p, int radius, bool draw_or_modify, T f, T f1, F is_locked)
{
